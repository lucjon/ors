...
\begin{defn}
	A \dn{partial bijection} from a set $X$ to a set $Y$ is a partial function which is a bijection from a subset of $X$ to a subset of $Y$. The \dn{symmetric inverse monoid} on a set $X$, denoted $\mathcal{I}_X$, is the set of all partial bijections from $X$ to $X$, where the operation is taken to be composition of relations.
\end{defn}
